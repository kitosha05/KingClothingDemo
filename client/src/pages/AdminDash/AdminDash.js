    ...
    return (
        <div>
            <Route
                exact
                path={`${match.path}`}
                render={({ props }) => <Dashboard allOrders={allOrders} />}
            />
            <Route
                exact
                path={`${match.path}/orders`}
                render={({ props }) => (
                    <OrderAdminPanel allOrders={allOrders} />
                )}
            />
            <Route
                exact
            ...
            <Route
                ...
                render={({ props }) => (
                    <ProductAdminPanel collections={collections} />
                )}
            />
            <Route
                exact
                path={`${match.path}/pages`}
                render={({ props }) => <PagesAdminPanel />}
            />
            <Route
                exact
                path={`${match.path}/reports`}
                render={({ props }) => (
                    <ReportsAdminPanel allOrders={allOrders} />
                )}
            />
            <Route
                exact
                path={`${match.path}/blog`}
                render={({ props }) => <BlogAdminPanel />}
            />
        </div>
    )
}
