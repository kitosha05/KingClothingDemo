...
const UserOrderHistory = lazy(() =>
    import('./pages/UserOrderHistory/UserOrderHistory')
)
...
const CompleteCheckout = lazy(() =>
    import('./pages/CompleteCheckout/CompleteCheckOut')
)
                        ...
                        <Fragment>
                            ...
                            <ErrorBoundary>
                                <Suspense fallback={<PlainSpinner />}>
                                    ...
                                    <Route
                                        exact
                                        path="/checkout/:orderId/complete-checkout"
